...
#            echo "passwd"
            echo "save"
        } | gpg1 --command-fd 0 --status-fd 1 --verbose --no-use-agent --expert --gnupg --interactive --no-default-keyring --homedir ./ --trustdb-name ./trustdb.gpg --keyring ./keyring.gpg --secret-keyring ./secring.gpg --s2k-digest-algo 'SHA512' --s2k-cipher-algo 'AES256' --s2k-mode '3' --s2k-count '65011712' --edit-key "${hash}"

        gpg1 --verbose --no-use-agent --expert --no-default-keyring --homedir ./ --trustdb-name ./trustdb.gpg --keyring ./keyring.gpg --secret-keyring ./secring.gpg --s2k-digest-algo 'SHA512' --s2k-cipher-algo 'AES256' --s2k-mode '3' --s2k-count '65011712' --armor --output ./${hash}${tag:+"${tag}"}.public.key --export ${hash}

        gpg1 --verbose --no-use-agent --expert --no-default-keyring --homedir ./ --trustdb-name ./trustdb.gpg --keyring ./keyring.gpg --secret-keyring ./secring.gpg --s2k-digest-algo 'SHA512' --s2k-cipher-algo 'AES256' --s2k-mode '3' --s2k-count '65011712' --armor --output ./${hash}${tag:+"${tag}"}.private.key --export-secret-keys ${hash}

        gpg1 --verbose --no-use-agent --expert --no-default-keyring --homedir ./ --trustdb-name ./trustdb.gpg --keyring ./keyring.gpg --secret-keyring ./secring.gpg --s2k-digest-algo 'SHA512' --s2k-cipher-algo 'AES256' --s2k-mode '3' --s2k-count '65011712' --armor --output ./${hash}${tag:+"${tag}"}.private.sub.key --export-secret-subkeys ${hash}
...
#        cat ./dump.key | grep -iP --color "(alg|bit)?"

        {
            ...
            echo y
            echo "${pwd}"
        } | gpg1 --command-fd 0 --status-fd 1 --verbose --no-use-agent --expert --gnupg --interactive --no-default-keyring --homedir ./ --trustdb-name ./trustdb.gpg --keyring ./keyring.gpg --secret-keyring ./secring.gpg --s2k-digest-algo 'SHA512' --s2k-cipher-algo 'AES256' --s2k-mode '3' --s2k-count '65011712' --armor --output ./${hash}${tag:+"${tag}"}.rev.key --gen-revoke ${hash}
...
#     echo y
#     echo "save"
# } | gpg1 --command-fd 0 --status-fd 1 --verbose --no-use-agent --expert --gnupg --interactive --no-default-keyring --homedir ./ --trustdb-name ./trustdb.gpg --keyring ./keyring.gpg --secret-keyring ./secring.gpg --s2k-digest-algo 'SHA512' --s2k-cipher-algo 'AES256' --s2k-mode '3' --s2k-count '65011712' --edit-key "${name} (GNUPG keys for ${resource}) <${email}>"
# } | gpg1 --command-fd 0 --status-fd 1 --verbose --no-use-agent --expert --gnupg --interactive --no-default-keyring --homedir ./ --trustdb-name ./trustdb.gpg --keyring ./keyring.gpg --secret-keyring ./secring.gpg --s2k-digest-algo 'SHA512' --s2k-cipher-algo 'AES256' --s2k-mode '3' --s2k-count '65011712' --edit-key "${main_hash}"

gpg1 --verbose --no-use-agent --expert --gnupg --interactive --no-default-keyring --homedir ./ --trustdb-name ./trustdb.gpg --keyring ./keyring.gpg --secret-keyring ./secring.gpg --s2k-digest-algo 'SHA512' --s2k-cipher-algo 'AES256' --s2k-mode '3' --s2k-count '65011712' --export-ownertrust > ./ownertrust.db
